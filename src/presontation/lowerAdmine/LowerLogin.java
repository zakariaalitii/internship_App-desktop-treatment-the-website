...
public class LowerLogin extends Dialog implements WindowListener, ActionListener {	
		...
		Button ok ;
		Button cancel;
		public LowerLogin(Frame owner, String title, boolean modal) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == ok ) {
			conx.selectAdmin( email, Password);
			if(conx.getSelectemail() != null &&  conx.getSelectpassword() != null) {
				//System.out.println("email>>>"+conx.getSelectemail());
				//System.out.println("email>>>"+conx.getSelectpassword());
				InformationLower information =new InformationLower(null, null, true);
		...
		if(e.getSource() == cancel){
			Index index= new Index(null, null, true);
		}
		setVisible(false);	
	}
	@Override
